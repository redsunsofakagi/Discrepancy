...
class Wit:
   ...
   def active(self, speaker, dialogue, c):
      ...
      SceneScreen.pack(side='bottom')
Scene004=Obj('Scene4.png', 300,150)
Scene004.create()
countobj=0
countwit=0
acountobj=0
   ...
   if k<(len(l2)) and m<(len(l1)) :
      ...
      for j in str1:
         if str1=='[inv]':
            ...
            del Scene004
            Scene04=Obj('Scene4.png', 300,150)
            Scene04.create()
            Pers001=Wit("Locke.png",150,220)
            Pers001.create()
            SceneScreen.update()
            SceneScreen.pack()
            raise NoError
            ...
            Scene4=Obj('Scene4.png', 300,150)
            Scene4.create()
            Pers1=Wit("Locke.png",150,220)
            Pers1.create()
            countobj=0
            countwit=0
            Pers2=Wit("Charles-removebg-preview.png",150,100)
            Pers2.create()
            SceneScreen.update()
            SceneScreen.pack()
            raise NoError
            ...
            SceneScreen.update()
            Scene05=Obj('Scene5.png', 300,150)
            Scene05.create()
            SceneScreen.update()
            countobj=0
            countwit=0
            Obj1_05=Obj("Road.png",300,150)
            Obj1_05.create()
            Obj2_05=Obj("Cars_11.png",300,160)
            Obj2_05.create()
            Obj3_05=Obj("Note1.png",400,140)
            Obj3_05.create()
            SceneScreen.update()
            SceneScreen.pack()
            raise NoError
            ...
            SceneScreen.update()
            Scene005=Obj('Scene5.png', 300,150)
            Scene005.create()
            SceneScreen.update()
            countobj=0
            countwit=0
            Obj1_005=Obj("Road.png",300,150)
            Obj1_005.create()
            Obj2_005=Obj("Cars_11.png",300,160)
            Obj2_005.create()
            Obj3_005=Obj("Note1.png",400,140)
            Obj3_005.create()
            Pers_J=Wit("James.png",500,250)
            Pers_J.create()
            SceneScreen.update()
            SceneScreen.pack()
            raise NoError
            ...
            SceneScreen.update()
            Scene0005=Obj('Scene5.png', 300,150)
            Scene0005.create()
            SceneScreen.update()
            countobj=0
            countwit=0
            Obj1_0005=Obj("Road.png",300,150)
            Obj1_0005.create()
            Obj2_0005=Obj("Cars_11.png",300,160)
            Obj2_0005.create()
            Obj3_0005=Obj("Note1.png",400,140)
            Obj3_0005.create()
            Pers_J0=Wit("James.png",500,250)
            Pers_J0.create()
            PersLo1=Wit("Locke.png",460,100)
            PersLo1.create()
            Aut=Obj("Autopsy.png",550,100)
            Aut.create()
            SceneScreen.update()
            SceneScreen.pack()
            raise NoError
            ...
            Scene6=Obj("Scene6.png",300,150)
            Scene6.create()
            acountobj=0
            acountwit=0
            Locke=Wit("Locke.png",510,100)
            Locke.create()
            James=Wit("James.png",90,100)
            James.create()
            Todo=aObj("Todo.png",290,100)
            Todo.acreate()
            ...
            countwit=0
            Scene_7=Obj("Scene7.png",300,150)
            Scene_7.create()
            Zimmer=Wit("Zimmerman.png",310,250)
            Zimmer.create()
            ...
            Scene07=Obj("Scene7.png",300,150)
            Scene07.create()
            Zimmer1=Wit("Zimmerman.png",310,250)
            Zimmer1.create()
...
def openopt():
    if TextBox.instate(['disabled'])==True and LineButton.instate(['disabled'])==True:
        ...
        menu=Toplevel(GameWindow)
        menu.title('Case Log')
        menu.geometry('400x228'+"-"+str(w)+str(int((-(scr_h/4.32))-270)))
        menu.resizable(width=False, height=False)
        menu.grab_set()
        def disable():
            pass
