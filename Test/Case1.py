...
pygame.init()
vol_lvl=0.10
tutorial_file = open("MainTutorial.txt" , 'r')
   ...
   if k<(len(l2)) and m<(len(l1)) :
      ...
      for j in str1:
         if str1=='[inv]':
            ...
            label = tkinter.Label(GameWindow, image=image_tk, bg="black")
            label.pack()
            ...
            SceneScreen.update()
            Scene1=Obj('1 actual.png', 300,150)
            Scene1.create()
            SceneScreen.update()
            countobj=0
            countwit=0
            Pers1=Wit("Locke.png",500,250)
            Pers1.create()
            Wit1=Wit('Maria.png', 60, 250)
            Wit1.create()
            Wit1.active('Witness', '...',1)
            Pers2=Wit('Antonnio.png', 60, 150)
            Pers2.create()
            Obj1=Obj("noose(278x137).png", 310, 140)
            Obj1.create()
            Obj1.active('Jones', '(The noose... it bears the marks of a struggle... Shouldn\'t show this to the kid.)', 3)
            Obj2=Obj("door(395x42).png", 510, 100)
            Obj2.create()
            Obj2.active('Jones', '(The backdoor. It\'s... locked from the outside. Maybe the autopsy team left through here.)', 3)
            Obj3=Obj("broken_vase(377x263).png", 210, 250)
            Obj3.create()
            ...
            acountobj=0
            SceneScreen.update()
            Scene001=Obj('1 actual.png', 300,150)
            Scene001.create()
            SceneScreen.update()
            countobj=0
            countwit=0
            Wit01=Wit('Maria.png', 60, 250)
            Wit01.create()
            Pers02=Wit('Antonnio.png', 60, 150)
            Pers02.create()
            Obj01=aObj("noose(278x137).png", 310, 140)
            Obj01.acreate()
            ...
            Obj02=aObj("door(395x42).png", 510, 100)
            Obj02.acreate()
            Obj02.aactive("Jones","(Of course, the backdoor. Who could have locked it?)",3)
            Obj03=aObj("broken_vase(377x263).png", 210, 250)
            Obj03.acreate()
            ...
            SceneScreen.update()
            Scene0001=Obj('1 actual.png', 300,150)
            Scene0001.create()
            SceneScreen.update()
            countobj=0
            countwit=0
            Pers01=Wit("Locke.png",500,250)
            Pers01.create()
            Wit001=Wit('Maria.png', 60, 250)
            Wit001.create()
            Pers002=Wit('Antonnio.png', 60, 150)
            Pers002.create()
            Obj001=Obj("noose(278x137).png", 310, 140)
            Obj001.create()
            Obj002=Obj("door(395x42).png", 510, 100)
            Obj002.create()
            Obj003=Obj("broken_vase(377x263).png", 210, 250)
            Obj003.create()
            SceneScreen.update()
            SceneScreen.pack()
            raise NoError
         elif str1=='[02]':
            Scene2=Obj("C1S3.png",300,150)
            Scene2.create()
            SceneScreen.update()
            SceneScreen.update()
            SceneScreen.pack()
