...
w02=(2*infoObject.current_w/4)
w03=(3*infoObject.current_w/4)+30
img_cred = Image.open('Photos\Slide1.png')
img_cred = img_cred.resize((infoObject.current_w, infoObject.current_h-50), Image.ANTIALIAS)
img_cred.save('Photos\Slide1.png')
img_cred = Image.open('Photos\Slide3.png')
img_cred = img_cred.resize((infoObject.current_w, infoObject.current_h-50), Image.ANTIALIAS)
img_cred.save('Photos\Slide3.png')
img_cred = Image.open('Photos\Slide4.png')
img_cred = img_cred.resize((infoObject.current_w, infoObject.current_h-50), Image.ANTIALIAS)
img_cred.save('Photos\Slide4.png')
img_cred = Image.open('Photos\Slide2.png')
img_cred = img_cred.resize((infoObject.current_w, infoObject.current_h-50), Image.ANTIALIAS)
img_cred.save('Photos\Slide2.png')
screen = pygame.display.set_mode((infoObject.current_w, infoObject.current_h-50))
screen.fill('Black')
pygame.display.set_caption('Discrepancy')
clock = pygame.time.Clock()
selite_font = pygame.font.Font(os.path.join(main_dir, 'SpecialElite-Regular.ttf'), 50)
title_music = pygame.mixer.Sound(os.path.join(main_dir, 'title_music.wav'))
...
button_case3 = button.Button(w02,hn/2, clr_bttn_179x67)
state_start = False
state_options = False
state_credits = False
vol_lvl=0.10
music_state = True
selite_font = pygame.font.Font(os.path.join(main_dir, 'SpecialElite-Regular.ttf'), 36)
